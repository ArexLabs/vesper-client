...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        panel: "var(--shadow)",
        lift: "0 18px 40px rgba(0, 0, 0, 0.38), inset 0 1px 0 rgba(255,255,255,0.03)",
        soft: "0 8px 24px rgba(0, 0, 0, 0.24)",
      },
      ringColor: {
        DEFAULT: "oklch(var(--ring) / 0.35)",
      },
    },
  },
  plugins: [],

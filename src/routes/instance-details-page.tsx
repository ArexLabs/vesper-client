...
export function InstanceDetailsPage() {
  ...
  const { t, i18n } = useT();
  const applyPresetToInstance = useLauncherStore(
    (s) => s.applyPresetToInstance,
  );
  const saveInstanceResolvedConfig = useLauncherStore(
    (s) => s.saveInstanceResolvedConfig,
  );
  const rollbackInstanceSnapshot = useLauncherStore(
    (s) => s.rollbackInstanceSnapshot,
  );
  ...
  const currentPreview =
    lastLaunchPreview?.instanceId === instance.id ? lastLaunchPreview : null;
          ...
          <div className="flex flex-wrap items-center gap-3 lg:ml-auto">
            <div className="flex h-10 sm:h-12 items-center gap-1.5 rounded-xl sm:rounded-2xl border border-border bg-surface2/50 px-3">
              ...
              <div className="text-[10px] sm:text-sm">
                <span className="hidden sm:inline text-textMuted">
                  Last played:{" "}
                </span>
              ...
              <div className="grid gap-6 lg:grid-cols-3">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <p className="text-sm text-textMuted leading-relaxed">
                        {instance.notes ||
                          "No notes provided for this instance."}
                      </p>
                ...
                <div className="space-y-6">
                  <Card>
                    ...
                    <CardContent className="grid gap-2">
                      <Button
                        ...
                        onClick={() =>
                          navigate(`/config-studio?instance=${instance.id}`)
                        }
                      >
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <Label
                        htmlFor="overview-preset-select"
                        className="sr-only"
                      >
                        Preset Selection
                      </Label>
                      ...
                      <p className="mt-3 text-xs text-textMuted leading-relaxed">
                        Presets allow you to quickly apply a group of settings
              ...
              <Card className="flex flex-col h-64 items-center justify-center border-dashed bg-surface2/30 text-textMuted">
                <div className="text-center p-6">
                  ...
                  <p className="text-xs mt-1">
                    Management UI is under construction.
                  </p>
            ...
            <TabsContent value="worlds" className="mt-0 outline-none">
              <Card className="flex flex-col h-64 items-center justify-center border-dashed bg-surface2/30 text-textMuted">
                <div className="text-center p-6">
                  ...
                  <p className="text-xs mt-1">
                    Singleplayer world management coming soon.
                  </p>
                  <Button variant="outline" className="mt-6 rounded-xl gap-2">
                    <FolderOpen className="size-4" />
                    Open Saves Folder
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setDraft({ ...draft, javaPath: e.target.value })
                        }
                      />
                    </div>
                  </CardContent>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                  ...
                  <Badge variant="outline">
                    {instance.snapshots.length} available
                  </Badge>
                </CardHeader>
                <CardContent>
